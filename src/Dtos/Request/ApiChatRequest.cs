...
public class ApiChatRequest
{
    ...
    /// </summary>
    public string Model { get; set; } = Constants.Models.ChatModel;
    ...
    public ResponseFormat? ResponseFormats { get; set; }
    ...
    public class ResponseFormat
    {
        ...
        /// 
        /// </summary>
        public string? Type { get; set; } = Constants.ResponseFormatTypes.Text;
    }
}
